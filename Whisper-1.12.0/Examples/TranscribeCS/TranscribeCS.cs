...
static class Program
{
	...
	{
		args = new string[] { 
			"-m", "C:\\Users\\techboy\\Documents\\GitHub\\SubtitleEditor_WASM\\LyricsExtractor\\LyricsExtractor\\Properties\\Resources\\ggml\\ggml-base.en.bin",
            "-f", "C:\\Users\\techboy\\Downloads\\karma.mp3",
        };
		try
		{
			// dbgListGPUs();
